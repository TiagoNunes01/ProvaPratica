...
<body>
	<a href="?imagem=note"><img src="comp.jpg" width="250px"></a>
	<?php 
		if(isset($_POST['nome']) && isset($_POST['cpu']) && isset($_POST['memoria']) && isset($_POST['armazenamento']) && isset($_POST['so'])) {
			...
			echo '<form method="post">
				...
				<select id="monitor" name="monitor" required>
				    <option value="19 Polegadas">19 polegadas - R$ 399,95</option>
				    <option value="22 Polegadas">21,5 polegadas - R$ 498,75</option>
				    <option value="24 Polegadas">23,8 polegadas - R$ 599,45</option>
				    <option value="32 Polegadas">32 polegadas - R$ 2.099,90</option>
			    </select>
			    <br>
